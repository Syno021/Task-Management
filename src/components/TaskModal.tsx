...
export default function TaskModal({
  ...
  return (
    <>
      ...
      {/* Slide-in Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full md:max-w-lg bg-white z-50 shadow-2xl flex flex-col transition-transform duration-300 ease-out ${
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 min-w-0 text-sm bg-stone-50 border border-stone-200 rounded-lg px-3 py-2.5 focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 placeholder-stone-400"
              />
              <button
